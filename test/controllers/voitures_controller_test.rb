...
class VoituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voiture" do
    assert_difference('Voiture.count') do
      post voitures_url, params: { voiture: { client_id: @voiture.client_id, couleur: @voiture.couleur, date_mise_en_service: @voiture.date_mise_en_service, immatriculation: @voiture.immatriculation, marque_id: @voiture.marque_id, modele: @voiture.modele } }
    end
  ...
  test "should update voiture" do
    patch voiture_url(@voiture), params: { voiture: { client_id: @voiture.client_id, couleur: @voiture.couleur, date_mise_en_service: @voiture.date_mise_en_service, immatriculation: @voiture.immatriculation, marque_id: @voiture.marque_id, modele: @voiture.modele } }
